const steps = [
  {
    n: "01",
    title: "Пишете в бот",
    desc: "Запускаете @aura_assistant_online_bot в Telegram, оставляете короткую заявку.",
  },
  {
    n: "02",
    title: "Обсуждаем задачи",
    desc: "Подбор тарифа, уточнение формата и приоритетов — без бюрократии.",
  },
  {
    n: "03",
    title: "Беру всё на себя",
