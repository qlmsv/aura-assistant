...
const script: Msg[] = [
  {
    from: "user",
    text: "У меня вся работа через меня. Команда не может без меня решить.",
  },
  {
    from: "aura",
    text: "Знакомая история. Созвонимся на 30 минут — расскажу с чего обычно начинаем. Бесплатно, без обязательств.",
  },
  { from: "user", text: "Сколько времени займёт?" },
  {
    from: "aura",
    text: "Диагностика — 2 недели. К концу первой уже будет понятно, что чинить в первую очередь.",
  },
];
